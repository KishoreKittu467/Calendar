...
import com.kizitonwose.calendar.compose.rememberFirstCompletelyVisibleMonth
...
import com.kkapps.bubbles.app.data.repository.DemoRepository.flightDateTimeFormatter
import com.kkapps.bubbles.app.data.repository.DemoRepository.generateFlights
import com.kkapps.bubbles.core.presentation.theme.Colors
import com.kkapps.common.ui.components.icons.AirplaneLanding
import com.kkapps.common.ui.components.icons.AirplaneTakeoff
import com.kkapps.common.ui.utils.applyScaffoldBottomPadding
import com.kkapps.common.ui.utils.applyScaffoldHorizontalPaddings
import com.kkapps.common.ui.utils.applyScaffoldTopPadding
...
@Composable
private fun LazyItemScope.FlightInformation(flight: DemoRepository.Flight) {
    Row(
        modifier = Modifier
            .fillParentMaxWidth()
...
@Composable
private fun AirportInformation(airport: DemoRepository.Flight.Airport, isDeparture: Boolean) {
    Row(
        modifier = Modifier
            .fillMaxWidth()
            .fillMaxHeight(),
    ) {
        val vector = if (isDeparture) AirplaneTakeoff else AirplaneLanding
        Box(
            modifier = Modifier
                .weight(0.3f)
                .fillMaxHeight()
