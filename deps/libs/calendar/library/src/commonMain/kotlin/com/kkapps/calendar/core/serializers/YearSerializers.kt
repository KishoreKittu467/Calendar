...
import com.kkapps.calendar.core.format.fromIso8601Year
...
public object YearIso8601Serializer : KSerializer<Year> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("com.kkapps.calendar.core.Year", PrimitiveKind.STRING)
...
public object YearComponentSerializer : KSerializer<Year> {
    override val descriptor: SerialDescriptor =
        buildClassSerialDescriptor("com.kkapps.calendar.core.Year") {
            element<Int>("year")
        }
