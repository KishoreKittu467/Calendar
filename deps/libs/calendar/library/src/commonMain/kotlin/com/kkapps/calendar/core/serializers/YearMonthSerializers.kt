package com.kkapps.calendar.core.serializers
...
public object YearMonthIso8601Serializer : KSerializer<YearMonth> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("com.kkapps.calendar.core.YearMonth", PrimitiveKind.STRING)
...
public object YearMonthComponentSerializer : KSerializer<YearMonth> {
    override val descriptor: SerialDescriptor =
        buildClassSerialDescriptor("com.kkapps.calendar.core.YearMonth") {
            element<Int>("year")
            element<Short>("month")
        }
